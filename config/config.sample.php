 ...
 * a cron background process and therefore uses the url of this key, even the user
 * has logged on via a different domain defined in key ``trusted_domains``. In case,
 * the user gets redirected to this url and must relogon.
 */
'overwrite.cli.url' => '',
